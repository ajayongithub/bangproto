...
function sendDataToServer(response,siteId,siteName){
	...
	var siteName = decodeURIComponent(getCookie("siteName"));
	var userName = $("#username").val();
	$.ajax({type:"POST",url:"<?php echo Yii::app()->createUrl('/kiosk/default/storeData')?>",data:{response:response,siteId:siteId,siteName:siteName,userName:userName },success:function(result){
	    //$("#div1").html(result);
