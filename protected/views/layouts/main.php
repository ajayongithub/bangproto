...
<body>
<img src="<?php echo Yii::app()->baseUrl ; ?>/images/splatlogo.png" alt="SplatStudio" align="middle" width=140/>
<div>
<?php echo Yii::app()->user->getFlash('flashMsg');?>
</div>
<div class="container" id="page">
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by Splat Studio.<br/>
